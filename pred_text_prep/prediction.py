...
prob_uni = pd.read_pickle('pickles/Final Probs/profanity-not/prob_uni_top50_np.pkl')
words_uni = list(prob_uni['Word1'])
prob_bi = pd.read_pickle('pickles/Final Probs/profanity-not/prob_bi_top5_np.pkl')
prob_tri = pd.read_pickle('pickles/Final Probs/profanity-not/prob_tri_top5_np.pkl')
prob_quad = pd.read_pickle('pickles/Final Probs/profanity-not/prob_quad_top5_np.pkl')
prob_penta = pd.read_pickle('pickles/Final Probs/profanity-not/prob_penta_top5_np.pkl')
prob_hexa = pd.read_pickle('pickles/Final Probs/profanity-not/prob_hexa_top5_np.pkl')
prob_hepta = pd.read_pickle('pickles/Final Probs/profanity-not/prob_hepta_top5_np.pkl')
prob_octa = pd.read_pickle('pickles/Final Probs/profanity-not/prob_octa_top5_np.pkl')
prob_nona = pd.read_pickle('pickles/Final Probs/profanity-not/prob_nona_top5_np.pkl')
prob_deca = pd.read_pickle('pickles/Final Probs/profanity-not/prob_deca_top5_np.pkl')
